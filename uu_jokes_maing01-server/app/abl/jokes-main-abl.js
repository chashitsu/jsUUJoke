...
class JokesMainAbl {
  ...
  async sayHello( dtoIn, uuAppErrorMap = {}) {
    //HDS 1
    ...
    <html>
      <body  style="background-color:black;">
        <center>
        <h1 style="color:lime; font-size: 200px;"> Hello ${dtoIn.name} ${(new Date()).toISOString()} uuAppErrorMap: ${JSON.stringify(uuAppErrorMap)}.</h1>
        </center>
      </body>
    </html>
    `;
